...
SELECT COUNT(classroom) AS classroms FROM course;
SELECT COUNT(DISTINCT classroom) AS classroms FROM course;

SELECT SUM(hours) AS total_hours FROM course; 
SELECT SUM(hours) AS total_hours FROM course WHERE teacher_id = 1;

SELECT AVG(hours) AS average_hours FROM course; 
